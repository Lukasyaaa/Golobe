                ...
                <div className={`introduction-${parentCl}__row introduction-page__row`}>
                    <div className={`introduction-${parentCl}__info introduction-page__info`}>
                        {(starsCount !== null)
                            ...
                            : <h2 className="introduction-flight__heading introduction-page__heading">{heading}</h2>
                        }
                        <Location 
                            parentCls={[`introduction-${parentCl}`, "introduction-page"]} 
                            info={locationInfo}
                         />
