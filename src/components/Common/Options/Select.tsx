...
import { FILL_RULE, ICON_POSITION, OPTION_ICON_VALUE, SELECT_DESCRIPTION_TYPE, STROKE_LINECAP, STROKE_LINEJOIN} from "../../../types";
import type { objType } from "../../../types";
import { Select } from "../../Common/Select/Select";
import { Text } from "../Select/Text";

interface OptionsSelectProps{
    iconValue : null | objType<typeof OPTION_ICON_VALUE>,
    description : string,
    links : string[],
}
    ...
    if(iconValue !== null){
        ...
        return(
            <div className="options__fieldset fieldset-options select have-icon" ref={select}>
                ...
                >
                    <Select 
                        parentCl="select-fieldset-options"
                        iconValue={{
                        ...
                        links={links} isOpened={isOpened} activeLink={activeLink}
