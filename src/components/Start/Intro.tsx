...
export const Intro : FC = () =>{
    ...
    if(state.heading !== "" && state.subheading !== "" && state.supheading !== "" && (state.background.jpeg !== "" || (isWebp && state.background.webp !== ""))){
        return(
            <section className="start__intro intro-start intro">
                <div 
                ...
                >
                    <div className="container_header">
                        <div className="intro-start__supheading intro__supheading">{state.supheading}</div>
                        <h1 className="intro-start__heading intro__heading">{state.heading}</h1>
                        <div className="intro-start__subheading intro__subheading">{state.subheading}</div>
                    </div>
                </div>
