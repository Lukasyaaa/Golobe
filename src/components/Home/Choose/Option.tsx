...
import type { ChooseOption as About } from "../../../types";
    ...
    return(
        ...
        >
            <div className="option-choose__inner">
                <h3 className="option-choose__title">{about.heading}</h3>
                <div className="option-choose__description">{about.description}</div>
                <a className="option-choose__link link-option-choose" href={linkPath}>
                    ...
                    <span className="link-option-choose__description">{about.button}</span>
                </a>
            </div>
        </div>
    );
