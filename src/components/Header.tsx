...
export const Header : FC = () => {
    ...
    const aboutMenu : AboutLink[] = [
        {
            description: about.links.flightsPart, 
            iconValue: {
        ...
        {
            description: about.links.hotelsPart, 
            iconValue: {
    ...
    return(
        <header className={["header", isOpen ? "_active" : "", (isScrolled) ? "_scroll" : ""].filter(Boolean).join(" ")}>
            <div className="container_header">
                <nav className="header__menu menu">
                    <ul className="menu__list">
                        {aboutMenu.map(({description, iconValue}, i) => 
                            <li className="menu__punkt" key={i}>
                                <a className={["menu__link", "link-menu", description].join(" ")} href="#">
                ...
                <nav className="header__authorization">
                    <a 
                        className={[
                            "header__link", "header__log-in", (hoveredIndex === 0) ? "_hovered" : ""
                        ].filter(Boolean).join(" ")} href="#" 
                        onMouseEnter={() => setHoveredIndex(0)} onFocus={() => setHoveredIndex(0)}
                    >
                        <span>{about.authorization.login}</span>
                    </a>
                    <a 
                        className={[
                            "header__link", "header__sign-in", (hoveredIndex === 1) ? "_hovered" : ""
                        ].filter(Boolean).join(" ")} href="#" 
                        onMouseEnter={() => setHoveredIndex(1)} onFocus={() => setHoveredIndex(1)}
                    >
                        <span>{about.authorization.signUp}</span>
                    </a>
                </nav>
                <button className="header__burger" onClick={() => setIsOpen((prev) => !prev)}>
                    <span></span>
                </button>
            </div>
        </header>
