...
import { navbarItem, navbarItemType, navbarRadio } from "../../../types";
import { useDispatch } from "react-redux";
import { navbarSetActiveItemAction, navbarSwapActiveAction } from "../../../store/flights/navbarReducer";
...
interface navbarRadiosProps{
    ...
    radioCount : number,
    radioGroupId : number,
    navbarGroups : navbarItem[]
}

export const NavbarRadios : FC<navbarRadiosProps> = ({about, id, radioCount, radioGroupId, navbarGroups}) =>{
    ...
    const setActive = (idItem : number, idGroup : number) =>{
        dispatch(navbarSetActiveItemAction(idItem, idGroup));
    }
