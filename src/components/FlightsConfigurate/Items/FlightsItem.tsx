            ...
            <div className="link-flights-items__info">
                <div className="link-flights-items__header">
                    <div className="link-flights-items__assessment-block">
                        <div className="link-flights-items__rating">{about.ratingNumb}</div>
                        <div className="link-flights-items__rating-text">{about.ratingText}</div>
                        <div className="link-flights-items__count-reviews">{`${about.countReviews} reviews`}</div>
                    </div>
                    <div className="link-flights-items__price">{about.subprice}<mark>${about.price}</mark></div>
                </div>
