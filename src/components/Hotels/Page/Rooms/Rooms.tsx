...
export const Rooms : FC<RoomsProps> = ({about, hotelId, checkInCheckOut}) => {
    return(
        <section className="hotel-page__section section hotel-page__rooms rooms">
            <div className="container">
                ...
                <div className="rooms__items">
                    {about.map((room, i) => <Room key={i} id={i} about={room} hotelId={hotelId} checkInCheckOut={checkInCheckOut} />)}
                </div>
            </div>
        </section>
    )
