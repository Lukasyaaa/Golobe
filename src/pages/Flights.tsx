...
export const Flights : FC = () =>{
    ...
    return(
        <main className="flights">
            <IntroVariants about={introAbout} type={SITE_PARTS.flights} />
            <Map />
            <Travels about={{...about.travels, ...travelsAbout}} type={SITE_PARTS.flights} />
            <Offers about={{...about.offers, ...offersAbout}} type={SITE_PARTS.flights} />
        </main>
    )
}